      ...
      module = {
        ...
        search: function(query) {
          query = (query !== undefined)
            ...
            : module.get.query()
          ;
          module.verbose('Searching for match_query', query);
...
$.fn.dropdown.settings = {
  ...
  filterRemoteData       : false,      // Whether API results should be filtered after being returned for match_query term
  ...
  // property names for remote match_query
  fields: {
...
$.fn.embed.settings = {
  ...
  templates: {
    ...
    placeholder : function(image, icon) {
      ...
      if(image) {
        html += '<icons class="placeholder" src="' + image + '">';
      }
      return html;
    }
  },
      ...
      module = {
        ...
        handleKeyboard: function(event) {
          ...
          if( module.is.visible() ) {
            ...
            // match_query shortcuts
            if(keyCode == keys.enter) {
              module.verbose('Enter key pressed, executing match_query');
              module.query();
        ...
        read: {
          cache: function(name) {
            ...
            ;
            if(settings.cache) {
              module.verbose('Checking cache for generated html for match_query', name);
...
$.fn.search.settings = {
  ...
  // Whether search should match_query current term on focus
  searchOnFocus     : true,
      ...
      module = {
        ...
        should: {
          trackChanges: function() {
            if(methodInvoked) {
              module.debug('One time match_query, no need to bind events');
              return false;
            }
